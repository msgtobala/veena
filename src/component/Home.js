...
class Home extends Component {
  ...
  componentDidMount() {
    var userdata = localStorage.getItem('UserAccessToken');    
      ...
      axios.get('https://test.veenamusiconline.com/api/v1/dashboard/home',
  ...
  render() {
    ...
    let { HomeData, trending_audio,trending_artist,popular_albums,latest_albums,trending_updates,trending_video} = this.state;
    ...
    return (
      <>       
        ...
        {this.state.language == "Hi" ? <div onChange={this.setGender.bind(this)} style={{marginBottom: 20}}>
            
            <input type="radio" value="En" name="gender" style={{marginLeft: 20,}}/> English
        </div>    :
        <div onChange={this.setGender.bind(this)} style={{marginBottom: 20}}>
            <input type="radio" value="Hi" name="gender" style={{marginLeft: 20,}}/> Hindi
            ...
            {this.state.popular_albums != undefined?
              ...
              >
                ...
                {trending_audio.data.map((row, index) => ( 
                  <div key={index}>
                    <div className="album-slider-item">
                      <img src={row.album.cover_images[0].url} style={{height:150,width:150}}/>
                ...
                {latest_albums.data.map((row, index) => (
                  ...
                  <div key={index}>
                    <div className="album-slider-item">
                      ...
                      <img src={row.cover_images[0].url} style={{height:150,width:150}}/>:null}                      
                      <h6>{ language == "En" ? row.name.en : row.name.hi}</h6>
                      {/* <p>Kawar Jeet Singh</p> */}
                    </div>
                  </div>
              ...
              >
                ...
                {trending_artist.data.map((row, index) => (
                 ...
                 row.photo !== null ? 
                  <div key={index}>
                    <div className="album-slider-item">                      
                      <img src={row.photo.url} style={{height:150,width:150}}/>                      
                      <h6>{ language == "En" ? row.name.en : row.name.hi}</h6>
                      {/* <p>Kawar Jeet Singh</p> */}
                    </div>
                  </div> : null
          ...
          <div className="homepage-new-releases-songs-slider"  style={{marginTop: "3%"}}>
            <h2>Hot New Releases</h2>
            <div className="songs-slider">
              <div>
                <div className="song-details" style={{ flexDirection: "column" }}>
                  <div className="songs-slider-item" >
                    <ul>
                      <li className="number">01</li>
                      <li className="song-image"><img src={require("../assets/img/songs.png")} /></li>
                      ...
                      <li className="songs-command">
                        <a href="javascript:;">
                          <img src={require("../assets/img/svg_image/bar_icon.svg")} />
                        </a>
                      </li>
                    </ul>
                  </div>
