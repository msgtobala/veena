...
class Videos extends Component {
    ...
    componentWillMount(){
        ...
        if (userdata !== null) {
          ...
          axios.get('http://139.59.69.231/api/v1/dashboard/video',
        ...
        return (
            <>              
                ...
                <div className="middle-section">
                    <div id="jp_container_11" className="jp-video video-player-controller" role="application" aria-label="media player">
                        ...
                        <div className="jp-controls-holder">
                            ...
                            <div className="video-heart-icon">
                                <ul>
                                    <li><a href="javascript:;"><img src={require("../assets/img/heart-dark.png")} /></a></li>
                                    <li><a href="#add_playlist_modal"><img src={require("../assets/img/svg_image/bar_icon-dark.svg")} className="image-svg" /></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
